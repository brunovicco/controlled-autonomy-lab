...
#   CMD ["uvicorn", "harness_example.entrypoints.http:app", "--host", "0.0.0.0", "--port", "8000"]
#   CMD ["python", "-m", "harness_example"]
CMD ["python", "-c", "import harness_example; print(harness_example.__doc__)"]
